...
<body>
    ...
    <a href="perfil_aluno.php" class="back-icon">
        ...
        <div class="foto-atual">
            <h3>Foto Atual:</h3>
            <img src="../../assets/uploads/alunos/<?php echo empty($foto_perfil_aluno) && file_exists('../../assets/uploads/alunos/'. $foto_perfil_personal) ? htmlspecialchars( $foto_perfil_aluno) : 'Profile-PNG-File.png' ?>"  class="foto-perfil" alt="foto do usuario"/>
        </div>
