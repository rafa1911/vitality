...
<body>
    ...
    <div class="main-content">
        ...
        <div id="form-avaliacao" class="document-form">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <button type="button" class="btn-cancel" onclick="cancelUpload()">Cancelar</button>
    </div>
            </form>
        </div>
    ...
    const closePopup = document.getElementById('popup-close-solicitacoes'); // Corrigir aqui
