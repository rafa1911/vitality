    ...
    <ul>
      <li>
        <a href="#" onclick="showPopup()">
          <img src="../../assets/uploads/personais/<?php echo empty($foto_perfil_personal) && file_exists('../../assets/uploads/personais/' . $foto_perfil_personal) ? htmlspecialchars($foto_perfil_personal) : 'Profile-PNG-File.png' ?>"/>
